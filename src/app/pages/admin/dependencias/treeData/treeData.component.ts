...
const TREE_DATA: FoodNode[] = [
  {
    ...
    children: [
      {
        id: 2,
        name: 'Dirección de Gestión Académica'}, 
        {
          id: 3,
          name: 'Dirección de Gestión de la Calidad Institucional'}],
  },
  {
    id: 4,
    name: 'Vice-Rectoría',
    children: [{
      id: 5,
      name: 'División de Desarrollo Tecnológico de la Información y Comunicación'}, { id: 6,name: 'Centro de Biología Molecular'}, {
